...
export default function CTASection({ locale, contactLabel, quoteLabel }: CTASectionProps) {
  ...
  return (
    <section ref={sectionRef} className="section-sm bg-white">
      <div className="container-wide">
        <div className="relative bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 rounded-4xl p-10 md:p-16 lg:p-20 overflow-hidden">
          {/* Background Decorations */}
          <div className="absolute top-0 end-0 w-80 h-80 bg-white/5 rounded-full blur-3xl" />
          <div className="absolute bottom-0 start-0 w-60 h-60 bg-accent-500/10 rounded-full blur-3xl" />
          <div className="absolute top-1/2 start-1/4 w-40 h-40 bg-primary-400/10 rounded-full blur-2xl" />
