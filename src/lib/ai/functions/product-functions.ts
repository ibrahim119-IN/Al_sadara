  ...
  try {
    ...
    return {
      ...
      product: {
        ...
        polymerSpecs: (product as any).polymerSpecs,
        masterbatchSpecs: (product as any).masterbatchSpecs,
        stock: product.stock,
  ...
  try {
    ...
    const comparison = {
      products: products.docs.map((p) => ({
        ...
        polymerSpecs: (p as any).polymerSpecs,
        masterbatchSpecs: (p as any).masterbatchSpecs,
