...
export async function generateMetadata({
  ...
  return {
    ...
    keywords: isArabic
      ? ['شركات ITs', 'مجموعة السيد شحاتة', 'الصدارة للصناعة', 'التالة الخضراء', 'كوديراتك', 'شركات مصر', 'شركات السعودية']
      : ['ITs companies', 'El Sayed Shehata Group', 'Al Sadara Industry', 'Al Talah', 'Coderatech', 'Egypt companies', 'Saudi companies'],
    alternates: {
