  ...
  const mockResults: SearchResult[] = [
    {
      ...
      titleAr: 'بولي إيثيلين عالي الكثافة HDPE',
      description: 'Premium quality HDPE for pipes and containers',
      descriptionAr: 'بولي إيثيلين عالي الكثافة للأنابيب والحاويات',
    ...
    },
    {
      ...
      titleAr: 'بولي إيثيلين منخفض الكثافة LDPE',
      description: 'Flexible LDPE for films and packaging',
      descriptionAr: 'بولي إيثيلين مرن للأغشية والتغليف',
    ...
    },
    {
      ...
      descriptionAr: 'تجارة خامات البلاستيك - جدة، السعودية',
      url: '/companies/sadara-industry',
    },
    {
      id: '4',
      type: 'company',
    ...
    },
    {
      ...
      title: 'About Us',
      titleAr: 'من نحن',
      description: 'Learn about El Sayed Shehata Group of Companies',
      descriptionAr: 'تعرف على مجموعة شركات السيد شحاتة',
      url: '/about',
    },
  ]
