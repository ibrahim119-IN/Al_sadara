...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        'ar': `${BASE_URL}/ar/checkout`,
        'en': `${BASE_URL}/en/checkout`,
      },
    },
  }
}
...
export default async function CheckoutPage({ params }: CheckoutPageProps) {
  ...
  const breadcrumbItems = [
    { label: isRTL ? 'سلة التسوق' : 'Cart', href: `/${locale}/cart` },
    { label: isRTL ? 'إتمام الطلب' : 'Checkout' },
  ]
  ...
  const content = {
    ...
    en: {
      title: 'Checkout',
      subtitle: 'Complete your shipping and payment details',
    },
  }
