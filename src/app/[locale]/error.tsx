          ...
          <div className="max-w-lg w-full text-center">
            ...
            <div className="mb-8">
              <div className="relative inline-block">
                <div className="absolute inset-0 bg-error-100 rounded-full blur-xl opacity-50 animate-pulse" />
                <div className="relative bg-white rounded-full p-6 shadow-lg border border-error-100">
            ...
            {process.env.NODE_ENV === 'development' && error.message && (
              <div className="mb-8 p-4 bg-error-50 rounded-xl border border-error-200 text-start">
